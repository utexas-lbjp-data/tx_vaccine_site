...
highchart(type = "stock") %>% 
      ...
      hc_title(
        ...
        useHTML = TRUE) %>%
hc_subtitle(
        text ="Shown are the number of reported daily administered doses across the state of Texas and the 7-day average of daily adminsitered doses.<br>LEGEND - <span style='color: #bf5700'>7-DAY ROLLING AVG.</span>",
        useHTML = TRUE) %>% 
