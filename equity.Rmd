...
```{r covid_case_fatality_dem_chart, echo=FALSE, fig.height=6.5, fig.width=10, layout = "l-page"}
...
dem_data_full <- bind_rows(dem_cf_data,
  ...
  mutate(measure_f = factor(measure, levels=c('Doses Administered','Partially Vaccinated',
                                              'Fully Vaccinated','Cases', 'Fatalities', 'State Population'))) %>% 
...
time_pulled <-  unique(vaccine_sites_sf$time_pulled)
  ...
  labs(title = "~5.7m Texans are a 30+min drive from a Vaccine Hub",
      ...
      # ggsave(paste0("figures/",today,"_","inaccessible_hub_30min.png"), dpi = 300, width = 11, height = 11)
